# Datascientest LabOps: Development Setup Guide

This document provides step-by-step instructions for setting up and running the Datascientest LabOps locally for development purposes.
