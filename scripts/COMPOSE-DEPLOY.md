# Datascientest LabOps Deployment Guide

This guide provides instructions for deploying the Datascientest LabOps on different operating systems.
...
After successful installation, you can access Datascientest LabOps at:
```
http://localhost:30080
```

## Managing Datascientest LabOps
...
To completely remove Datascientest LabOps:
