...
print_header() {
    ...
    echo -e "${NC}"
    echo -e "${CYAN}==============================================================${NC}"
    echo -e "${CYAN}Datascientest LabOps: Kubernetes Certification Exam Simulator${NC}"
...
main() {
    ...
    echo -e "${CYAN}==============================================================${NC}"
    echo -e "${GREEN}✓ Datascientest LabOps has been installed successfully${NC}"
    ...
    echo -e "${CYAN}==============================================================${NC}"
    echo -e "${YELLOW}Datascientest LabOps has been installed in:${NC} ${GREEN}$(pwd)${NC}, run all below commands from this directory"
    ...
    echo -e "${YELLOW}To access Datascientest LabOps:${NC} ${GREEN}https://play.sailor.sh/${NC}"
    echo
    echo -e "${CYAN}Thank you for installing Datascientest LabOps!${NC}"
}
